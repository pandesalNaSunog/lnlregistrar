        ...
        @foreach ($promotionReport as $report)
            <div class="card shadow mt-3">
                <div class="card-header">
                    <h5 class="fw-bold"><small>{{ $report['program'] . ' Year Level: ' . $report['year_level'] }}</small>
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($report['students'] as $key => $student)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ strtoupper($student['student']->last_name . ', ' . $student['student']->first_name . ' ' . $student['student']->middle_name) }}
                                        </td>
