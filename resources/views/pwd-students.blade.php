    ...
    <div class="container py-5">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link active" href="#">List of PWD Students and Students with PWD Parent</a>
            </li>
            <li class="nav-item">
                                ...
                                <tbody>
                                    @foreach ($students as $key => $student)
                                        <tr>
                                            ...
                                            <td>
                                                 @if ($student->student_with_pwd_parent == 'on')
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                        height="30" fill="currentColor" class="bi bi-check"
                                                        viewBox="0 0 16 16">
                                                        <path
